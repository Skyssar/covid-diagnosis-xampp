...
<div class="container principal-container">
        ...
        <div class="option-card">
            ...
            <a href="registro-sintomas.php"><img class="option-card-img" src="img/queen.jpg" alt="opt1"></a>
        </div>
        <div class="option-card">
            <div class="option-card-text">Listado de usuarios</div>
            <a href="lista-usuarios.php"><img class="option-card-img" src="img/ui.png" alt="opt2"></a>
        </div>
